        ...
        <div className="fixed inset-x-0 bottom-0 z-100 flex justify-center pb-[max(1rem,env(safe-area-inset-bottom))] px-4 pointer-events-none">
            <AnimatePresence mode="wait" initial={false}>
                {!isEditing ? (
                    ...
                    >
                        <Button size="sm" onClick={onEdit} className="gap-2 h-11 px-5 rounded-full shadow-lg">
                    ...
                    <motion.div
                        ...
                        className="pointer-events-auto flex items-center gap-2 rounded-2xl bg-card border border-border/50 shadow-2xl backdrop-blur-md px-3 py-2.5 w-full max-w-md sm:w-auto"
                    >
