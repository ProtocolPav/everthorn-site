...
function ApplicationForm() {
    ...
    return (
        <div className="min-h-screen w-screen bg-gradient-to-br from-background via-background to-muted/20 flex flex-col">
            <div className="flex-1 flex flex-col max-w-2xl mx-auto w-full">
                {/* Fixed Header */}
                <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-lg border-b border-border/50 px-4 pt-4 pb-3">
                    <FormHeader
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="px-4 py-6">
                        ...
                        >
                            <Card className="relative backdrop-blur-sm bg-background/80 border-border/50 shadow-xl">
                ...
                {/* Fixed Footer */}
                <div className="sticky bottom-0 z-10 bg-background/80 backdrop-blur-lg border-t border-border/50 px-4 py-3">
                    <FormFooter
                        currentStep={currentStep}
                        totalSteps={allSteps.length}
