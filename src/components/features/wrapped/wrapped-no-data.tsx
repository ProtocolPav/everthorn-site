// components/features/wrapped/wrapped-no-data-screen.tsx
"use client";

import { motion } from "motion/react";
import Link from "next/link";

export function WrappedNoDataScreen() {
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-lg">
                ...
                >
                    {/* Pixelated corners */}
                    <div className="absolute -top-1 -left-1 w-3 h-3 bg-amber-500/40" />
                    <div className="absolute -top-1 -right-1 w-3 h-3 bg-amber-500/40" />
                    <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-amber-500/40" />
                    <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-amber-500/40" />

                    <div
                        className="p-8 md:p-12 border-2 border-amber-500/30 bg-card/90 backdrop-blur-sm text-center space-y-8"
                        style={{
                            clipPath:
                    ...
                    >
                        ...
                        >
                            <div className="relative">
                                <div className="w-20 h-20 flex items-center justify-center bg-gradient-to-br from-amber-500/20 to-yellow-500/20 border-2 border-amber-500/30">
                        ...
                        <motion.div
                            ...
                            className="space-y-4"
                        >
                            <h2 className="text-3xl md:text-4xl font-minecraft-seven bg-gradient-to-r from-amber-400 via-yellow-400 to-orange-400 text-transparent bg-clip-text">
                                No Wrapped Data
                            </h2>
                            <p className="text-base md:text-lg font-minecraft-seven text-muted-foreground leading-relaxed">
                                There is no Wrapped data linked to your account yet.
                            </p>
                            <p className="text-sm font-minecraft-ten text-muted-foreground/70">
                                Play more and come back next season to unlock your stats.
                            </p>
                        </motion.div>
