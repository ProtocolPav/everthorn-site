// components/features/wrapped/wrapped-teaser-screen.tsx
"use client";
...
export function WrappedTeaserScreen() {
    return (
                ...
                >
                    ...
                    >
                        ...
                        <motion.ul
                            ...
                            className="text-left text-sm md:text-base font-minecraft-ten text-muted-foreground/80 space-y-2 max-w-md mx-auto"
                        >
                            <li>• See how you've played.</li>
                            <li>• Discover your peak days and late-night grinds.</li>
                            <li>• Flex your Everthorn Wrapped.</li>
                        </motion.ul>
